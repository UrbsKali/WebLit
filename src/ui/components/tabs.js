...
export class TabManager {
    ...
    switchTab(tabId) {
        ...
        // Update URL/History logic could go here
        ...
        switch(tabId) {
            case 'chat':
                viewport.innerHTML = `<div class="p-10 flex flex-col h-full bg-slate-900">
                    <div id="chat-history" class="flex-1 overflow-y-auto custom-scrollbar mb-4 space-y-4">
                        <!-- Chat Items -->
                    ...
                    <div class="relative">
                        <textarea class="w-full bg-slate-800 border border-slate-700 rounded-xl p-4 pr-12 text-slate-200 focus:outline-none focus:border-indigo-500 resize-none h-24" placeholder="Type your message..."></textarea>
                        <button class="absolute right-3 bottom-3 p-2 bg-indigo-600 rounded-lg text-white hover:bg-indigo-500">
